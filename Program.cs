...
using ClubManagmentSystem.Repo.Implementations;
...
builder.Services.AddScoped<IGenericRepo<Member>, MemberRepo>();
builder.Services.AddScoped<IGenericRepo<Registration>, RegistrationRepo>();
